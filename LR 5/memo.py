...
def main():
    ...
    for n in n_list:
        ...
        fact_iterative_memo.cache_clear()

        time_recursive = benchmark(fact_recursive, n, number=1000)
        time_iterative = benchmark(fact_iterative, n, number=1000)
        time_recursive_memo = benchmark(fact_recursive_memo, n, number=10000)
        time_iterative_memo = benchmark(fact_iterative_memo, n, number = 10000)
